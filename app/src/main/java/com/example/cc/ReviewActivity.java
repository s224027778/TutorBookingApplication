    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isInserted) {
                    Toast.makeText(ReviewActivity.this, "Review sent, sending you to home page", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(ReviewActivity.this,StudentHomeActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(ReviewActivity.this, "Review Summission Failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
